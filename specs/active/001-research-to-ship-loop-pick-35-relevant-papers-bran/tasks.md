...
- [ ] 1.2 Implement `load_voice_exemplars(brand: str) -> VoiceExemplars | None` with markdown parsing
- [ ] 1.3 Handle edge cases: missing file, empty file, no blockquotes, malformed markdown
